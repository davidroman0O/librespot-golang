...
func LoginOAuth(deviceName string, clientId string, clientSecret string, cb func(url string)) (*core.Session, error) {
	return core.LoginOAuth(deviceName, clientId, clientSecret, cb)
}
